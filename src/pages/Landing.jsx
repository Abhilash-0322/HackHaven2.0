    ...
    <div className="w-full">
      ...
      {isAuthenticated && (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
          <div className="bg-gradient-to-r from-purple-50 to-indigo-50 p-6 rounded-xl shadow-md mb-6">
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-gray-600 mt-1">
                  Continue your wellness journey with ZenHeaven
                </p>
              </div>
              <div className="flex items-center bg-yellow-100 px-4 py-2 rounded-full">
                <Award className="h-5 w-5 text-yellow-600 mr-2" />
                <span className="font-semibold text-yellow-800">{calmCoins} Calm Coins</span>
              </div>
            </div>
          </div>
        </div>
