  ...
  return (
    <div className="min-h-screen bg-cream flex">
      <div className="hidden lg:flex lg:w-1/2 bg-editorial-ink text-cream p-12 flex-col justify-center">
        ...
        <QuoteBlock quote="Almost everything will work again if you unplug it for a few minutes, including you." attribution="Anne Lamott" className="border-terracotta text-cream/80 !text-xl" />
      </div>
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          ...
          <p className="mt-6 text-center font-sans text-sm text-charcoal-muted">Don&apos;t have an account? <Link to="/register" className="editorial-link">Create one</Link></p>
        </div>
      </div>
    </div>
  );
