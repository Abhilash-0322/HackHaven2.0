  ...
  return <div className="landing">
    ...
    <section className="hero section-pad">
      <div className="hero-copy">
        <div className="eyebrow"><span className="eyebrow-line" /> ZENHEAVEN / GAS ABSTRACTION PAYMASTER</div>
        <h1>Remove friction from care <em>with ZenHeaven.</em></h1>
        <p className="hero-lede">A gas abstraction paymaster for wellness: let the infrastructure disappear so the ritual can begin.</p>
    ...
    <section className="marquee"><span>GAS ABSTRACTION PAYMASTER / CARE FOR YOUR INNER WEATHER</span><span>✳</span><span>GAS ABSTRACTION PAYMASTER / CARE FOR YOUR INNER WEATHER</span><span>✳</span><span>GAS ABSTRACTION PAYMASTER / CARE FOR YOUR INNER WEATHER</span></section>
    <section className="intro section-pad" id="how-it-works"><div className="section-kicker">01 / The premise</div><div className="intro-grid"><h2>Gas Abstraction Paymaster is a practice to <em>return to.</em></h2><div><p>It is a relationship to tend. We bring the helpful things together — a place to talk, a page to reflect on, a song to shift the air — so you can meet yourself with a little more kindness.</p><Link className="text-link" to="/register">Find your starting point <ArrowRight size={15} /></Link></div></div></section>
