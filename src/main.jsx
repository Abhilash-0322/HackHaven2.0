  ...
  return <div className="landing">
    ...
    <section className="hero section-pad">
      <div className="hero-copy">
        <div className="eyebrow"><span className="eyebrow-line" /> ZENHEAVEN / BITCOIN L2 WELLNESS BRIDGE</div>
        <h1>Anchor your calm on Bitcoin <em>with ZenHeaven.</em></h1>
        <p className="hero-lede">A wellness bridge with Bitcoin-grade resilience, built for the moments that need a steady layer.</p>
    ...
    <section className="marquee"><span>BITCOIN L2 WELLNESS BRIDGE / CARE FOR YOUR INNER WEATHER</span><span>✳</span><span>BITCOIN L2 WELLNESS BRIDGE / CARE FOR YOUR INNER WEATHER</span><span>✳</span><span>BITCOIN L2 WELLNESS BRIDGE / CARE FOR YOUR INNER WEATHER</span></section>
    <section className="intro section-pad" id="how-it-works"><div className="section-kicker">01 / The premise</div><div className="intro-grid"><h2>Bitcoin L2 Wellness Bridge is a practice to <em>return to.</em></h2><div><p>It is a relationship to tend. We bring the helpful things together — a place to talk, a page to reflect on, a song to shift the air — so you can meet yourself with a little more kindness.</p><Link className="text-link" to="/register">Find your starting point <ArrowRight size={15} /></Link></div></div></section>
