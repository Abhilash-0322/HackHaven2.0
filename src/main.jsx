  ...
  return <div className="landing">
    ...
    <section className="hero section-pad">
      <div className="hero-copy">
        <div className="eyebrow"><span className="eyebrow-line" /> ZENHEAVEN / MODULAR WELLNESS STACK</div>
        <h1>Compose a calmer inner stack <em>with ZenHeaven.</em></h1>
        <p className="hero-lede">A modular wellness stack where every ritual becomes a dependable layer of support.</p>
    ...
    <section className="marquee"><span>MODULAR WELLNESS STACK / CARE FOR YOUR INNER WEATHER</span><span>✳</span><span>MODULAR WELLNESS STACK / CARE FOR YOUR INNER WEATHER</span><span>✳</span><span>MODULAR WELLNESS STACK / CARE FOR YOUR INNER WEATHER</span></section>
    <section className="intro section-pad" id="how-it-works"><div className="section-kicker">01 / The premise</div><div className="intro-grid"><h2>Modular Wellness Stack is a practice to <em>return to.</em></h2><div><p>It is a relationship to tend. We bring the helpful things together — a place to talk, a page to reflect on, a song to shift the air — so you can meet yourself with a little more kindness.</p><Link className="text-link" to="/register">Find your starting point <ArrowRight size={15} /></Link></div></div></section>
