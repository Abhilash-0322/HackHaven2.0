  ...
  return <div className="landing">
    ...
    <section className="hero section-pad">
      <div className="hero-copy">
        <div className="eyebrow"><span className="eyebrow-line" /> A softer place to land</div>
        <h1>Make room for your <em>whole self.</em></h1>
        <p className="hero-lede">ZenHeaven is a considered collection of tools, people, and tiny rituals for feeling more like you.</p>
    ...
    <section className="marquee"><span>CARE FOR YOUR INNER WEATHER</span><span>✳</span><span>CARE FOR YOUR INNER WEATHER</span><span>✳</span><span>CARE FOR YOUR INNER WEATHER</span></section>
    <section className="intro section-pad" id="how-it-works"><div className="section-kicker">01 / The premise</div><div className="intro-grid"><h2>Wellbeing is not a project to <em>perfect.</em></h2><div><p>It is a relationship to tend. We bring the helpful things together — a place to talk, a page to reflect on, a song to shift the air — so you can meet yourself with a little more kindness.</p><Link className="text-link" to="/register">Find your starting point <ArrowRight size={15} /></Link></div></div></section>
