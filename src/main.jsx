  ...
  return <div className="landing">
    ...
    <section className="hero section-pad">
      <div className="hero-copy">
        <div className="eyebrow"><span className="eyebrow-line" /> ZENHEAVEN / FULL-STACK DAPP SHOWCASE</div>
        <h1>Your complete care stack <em>with ZenHeaven.</em></h1>
        <p className="hero-lede">A full-stack dApp for everyday wellness, bringing reflection, conversation, and community into one home.</p>
    ...
    <section className="marquee"><span>FULL-STACK DAPP SHOWCASE / CARE FOR YOUR INNER WEATHER</span><span>✳</span><span>FULL-STACK DAPP SHOWCASE / CARE FOR YOUR INNER WEATHER</span><span>✳</span><span>FULL-STACK DAPP SHOWCASE / CARE FOR YOUR INNER WEATHER</span></section>
    <section className="intro section-pad" id="how-it-works"><div className="section-kicker">01 / The premise</div><div className="intro-grid"><h2>Full-Stack dApp Showcase is a practice to <em>return to.</em></h2><div><p>It is a relationship to tend. We bring the helpful things together — a place to talk, a page to reflect on, a song to shift the air — so you can meet yourself with a little more kindness.</p><Link className="text-link" to="/register">Find your starting point <ArrowRight size={15} /></Link></div></div></section>
