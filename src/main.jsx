  ...
  return <div className="landing">
    ...
    <section className="hero section-pad">
      <div className="hero-copy">
        <div className="eyebrow"><span className="eyebrow-line" /> ZENHEAVEN / CROSS-VM INTEROPERABILITY</div>
        <h1>Move gently across worlds <em>with ZenHeaven.</em></h1>
        <p className="hero-lede">A cross-VM wellness layer connecting the places, people, and practices that support your whole self.</p>
    ...
    <section className="marquee"><span>CROSS-VM INTEROPERABILITY / CARE FOR YOUR INNER WEATHER</span><span>✳</span><span>CROSS-VM INTEROPERABILITY / CARE FOR YOUR INNER WEATHER</span><span>✳</span><span>CROSS-VM INTEROPERABILITY / CARE FOR YOUR INNER WEATHER</span></section>
    <section className="intro section-pad" id="how-it-works"><div className="section-kicker">01 / The premise</div><div className="intro-grid"><h2>Cross-VM Interoperability is a practice to <em>return to.</em></h2><div><p>It is a relationship to tend. We bring the helpful things together — a place to talk, a page to reflect on, a song to shift the air — so you can meet yourself with a little more kindness.</p><Link className="text-link" to="/register">Find your starting point <ArrowRight size={15} /></Link></div></div></section>
