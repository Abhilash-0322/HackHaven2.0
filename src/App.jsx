    ...
    <div className="landing">
      ...
      <section className="hero page-width">
        <div className="hero-copy">
          <div className="eyebrow"><span className="pulse-dot" /> a little room to breathe</div>
          <h1>Softly, <br /><i>one thing at a time.</i></h1>
          <p className="hero-lede">A tactile calm space where gentle structure and generous breathing room help you come back to yourself.</p>
