    ...
    <div className="landing">
      ...
      <section className="hero page-width">
        <div className="hero-copy">
          ...
          <h1>Welcome <br /><i>back, friend.</i></h1>
          <p className="hero-lede">A familiar little desktop for journaling, chatting, and opening a new window when the day feels heavy.</p>
