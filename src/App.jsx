    ...
    <div className="landing">
      ...
      <section className="hero page-width">
        <div className="hero-copy">
          ...
          <h1>Drift <br /><i>into a softer state.</i></h1>
          <p className="hero-lede">A dreamy digital escape for late-night thoughts, ambient comfort, and finding your signal again.</p>
