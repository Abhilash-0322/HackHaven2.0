    ...
    <div className="landing">
      ...
      <section className="hero page-width">
        <div className="hero-copy">
          ...
          <h1>Your <br /><i>finest ritual is rest.</i></h1>
          <p className="hero-lede">A luminous private space for reflection, connection, and the kind of care that feels like a celebration.</p>
