  ...
  return (
    <div className="app-shell">
      <aside className={`sidebar ${open ? "sidebar-open" : ""}`}>
        <div className="brand-mark"><span>06</span><div><b>zenheaven</b><small>{product.brand} / {product.descriptor}</small></div></div>
      ...
      <main className="main-content">
        <header className="mobile-header"><button onClick={() => setOpen(true)} aria-label="Open menu"><Menu /></button><div className="mobile-logo">Routewise</div><Link to="/coins"><Coins size={18} /></Link></header>
        <Outlet />
      </main>
    </div>
  );
  ...
  return (
    <div className="landing">
      <header className="landing-nav page-width">
        <Link to="/" className="brand-mark"><span>06</span><div><b>zenheaven</b><small>{product.brand} / {product.descriptor}</small></div></Link>
      ...
      <section className="hero page-width">
        <div className="hero-copy">
          <div className="eyebrow"><span className="pulse-dot" /> {product.signal.toLowerCase()}</div>
          <h1>{product.hero}<br /><i>{product.heroAccent}</i></h1>
          <p className="hero-lede">{product.story}</p>
      ...
      <section className="story-strip" id="how-it-works">
        <div className="page-width"><div className="eyebrow">THE {product.brand.toUpperCase()} SIGNAL</div><h2>{product.hero}<br /><i>{product.heroAccent}</i></h2><p>Notice where you are. Find what helps. Return whenever you need to.</p>
      ...
      <footer className="landing-footer page-width"><Link to="/" className="brand-mark"><span>06</span><div><b>zenheaven</b><small>{product.brand} / {product.descriptor}</small></div></Link><span>Built for the in-between moments / Routewise.</span></footer>
    </div>
  );
}
