...
const themeStories = {
  "61-cyberpunk-neon": {
    eyebrow: "A neon refuge after dark", title: "Find your signal.", titleAccent: "Keep it glowing.",
    lede: "When the city gets loud, step into a quiet digital room built for honest thoughts and brighter next steps.",
    section: "Every mind has a frequency.", sectionAccent: "Tune into yours.",
    sub: "Notice the static. Find a little clarity. Return to your own signal.",
    cards: [["Let it out", "A private channel for the thoughts you keep buffering."], ["Make meaning", "Turn the day’s noise into a pattern you can understand."], ["Settle in", "Ambient tools and human support for your next small reset."]]
  },
  "62-forest-biophilic": {
    eyebrow: "A clearing for your mind", title: "Grow at your", titleAccent: "own pace.",
    lede: "A living, gentle space for grounding, reflection, and the small rituals that help you feel rooted again.",
    section: "Wellness is a forest.", sectionAccent: "Take the next step.",
    sub: "Arrive as you are. Notice what needs tending. Let support meet you there.",
    cards: [["Open the canopy", "A listening companion that makes room for whatever is present."], ["Put down roots", "A private journal for the moments you want to remember."], ["Find your trail", "Books, music, and care for the season you’re moving through."]]
  },
  "63-ocean-depth": {
    eyebrow: "A deeper breath below the surface", title: "Make space for", titleAccent: "the tide.",
    lede: "Slow down beneath the surface with calm tools for emotional currents, reflection, and a softer return to shore.",
    section: "Feelings move like water.", sectionAccent: "You can move with them.",
    sub: "Notice the wave. Breathe through the swell. Trust yourself to find calm water.",
    cards: [["Say what’s beneath", "A patient AI companion for the thoughts beneath the words."], ["Chart the current", "A private place to track moods, tides, and tiny turns."], ["Drift toward calm", "Curated stories and sounds for your depth-of-day."]]
  },
  "64-desert-sand": {
    eyebrow: "A warm place to pause", title: "There is room to", titleAccent: "begin again.",
    lede: "A sun-warmed corner for clarity, self-compassion, and finding the next honest step across the open space.",
    section: "You don’t need a map.", sectionAccent: "Just a moment.",
    sub: "Rest in the shade. Listen inward. Let one small choice become a direction.",
    cards: [["Set down the weight", "A thoughtful listener for the things you’ve been carrying."], ["Leave a marker", "A journal for the lessons, hopes, and small wins along the way."], ["Find an oasis", "Gentle music, books, and people when you want support."]]
  },
  "65-northern-lights": {
    eyebrow: "A little light for the long night", title: "Follow what", titleAccent: "still shines.",
    lede: "An aurora-lit space to make sense of your inner weather and find color in the next small moment.",
    section: "Healing is not linear.", sectionAccent: "It shimmers.",
    sub: "Look for the glow. Name what you need. Let support change shape around you.",
    cards: [["Send a signal", "A warm, always-open companion for the thoughts that need somewhere to land."], ["Map the sky", "A private journal for patterns, perspective, and new constellations."], ["Chase the glow", "Soothing sound, stories, and professional care when you’re ready."]]
  },
  "66-cherry-blossom": {
    eyebrow: "A quiet spring for your spirit", title: "Let this moment", titleAccent: "open softly.",
    lede: "A tender place for reflection, renewal, and the kind of care that honors every season you’re in.",
    section: "Nothing blooms on command.", sectionAccent: "Neither do you.",
    sub: "Pause beneath the petals. Notice the present. Trust the gentle timing of your becoming.",
    cards: [["Share the unsaid", "A kind listener for the feelings that are easier to write than speak."], ["Keep a small record", "A private journal for fleeting thoughts and lasting discoveries."], ["Wander gently", "Books, music, and support to accompany your next season."]]
  },
  "67-midnight-library": {
    eyebrow: "A study in being human", title: "Read between the", titleAccent: "lines of your life.",
    lede: "A candlelit refuge for curious minds, late-night feelings, and the quiet work of understanding yourself.",
    section: "Your story is still being written.", sectionAccent: "Turn the page.",
    sub: "Ask a better question. Keep the honest sentence. Let insight arrive in its own time.",
    cards: [["Open a conversation", "A discreet companion for the thoughts that keep you up at night."], ["Annotate the day", "A private journal for marginalia, memories, and meaning."], ["Choose your next volume", "Thoughtful books, music, and professional guidance for the chapter ahead."]]
  },
  "68-coffee-shop": {
    eyebrow: "Your favorite table is waiting", title: "Stay for a while,", titleAccent: "you’re welcome here.",
    lede: "A cozy corner for warm check-ins, unhurried reflection, and the little rituals that make a day feel possible.",
    section: "Care can be ordinary.", sectionAccent: "That’s the point.",
    sub: "Take the first sip. Say what’s on your mind. Let a little comfort count.",
    cards: [["Pull up a chair", "A friendly listener for your morning thoughts and midnight spirals."], ["Write it on a napkin", "A private journal for the moments worth keeping close."], ["Find your blend", "Music, books, and real support matched to your mood."]]
  },
  "69-space-cosmic": {
    eyebrow: "A quiet orbit of your own", title: "You are more than", titleAccent: "this moment.",
    lede: "A cosmic pause for big feelings, wide questions, and finding your coordinates when everything feels far away.",
    section: "There is no wrong trajectory.", sectionAccent: "Keep exploring.",
    sub: "Name the gravity. Give yourself room. Let one bright idea pull you forward.",
    cards: [["Transmit a thought", "A calm companion for the feelings that feel too vast to hold alone."], ["Log your orbit", "A private journal for patterns, discoveries, and gentle course-corrections."], ["Find another world", "Books, music, and trusted care for every kind of inner universe."]]
  },
  "70-rainy-day": {
    eyebrow: "A window seat for difficult days", title: "Let the rain fall.", titleAccent: "You can rest here.",
    lede: "A quiet, blue-gray room for slowing down, listening inward, and finding shelter without needing to pretend.",
    section: "Some days are for shelter.", sectionAccent: "That is enough.",
    sub: "Hear the weather. Name what hurts. Let a little kindness be your umbrella.",
    cards: [["Say it plainly", "A steady companion for the feelings that arrive with the storm."], ["Leave a note for tomorrow", "A private journal for honest check-ins and softer hindsight."], ["Make a rainy-day list", "Comforting books, music, and care for when you need more than words."]]
  }
};

const storyIcons = [MessageCircle, BookOpen, Headphones];
...
function Landing() {
  ...
  const story = themeStories[activeTheme] || themeStories["61-cyberpunk-neon"];
  return (
    <div className="landing">
      ...
      <section className="hero page-width">
        <div className="hero-copy">
          <div className="eyebrow"><span className="pulse-dot" /> {story.eyebrow}</div>
          <h1>{story.title} <br /><i>{story.titleAccent}</i></h1>
          <p className="hero-lede">{story.lede}</p>
      ...
      <section className="story-strip" id="how-it-works">
        <div className="page-width"><div className="eyebrow">THE ZENHEAVEN WAY</div><h2>{story.section}<br /><i>{story.sectionAccent}</i></h2><p>{story.sub}</p>
          <div className="story-cards">{story.cards.map(([title, text], index) => <StoryCard key={title} num={`0${index + 1}`} icon={storyIcons[index]} title={title} text={text} to={startPath} />)}</div>
        </div>
      </section>
