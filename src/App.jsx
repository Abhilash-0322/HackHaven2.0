...
import {
  ...
  Coins, Compass, Heart, Home, Library, LoaderCircle, LockKeyhole, LogOut, Menu, MessageCircle,
...
function LandingPage() {
  return (
    <div className="landing">
      <nav className="landing-nav"><Logo /><div className="landing-links"><a href="#how-it-works">How it works</a><a href="#tools">Your toolkit</a><Link to="/login">Sign in</Link><Link className="button button-primary" to="/register">Begin gently <ArrowRight size={16} /></Link></div></nav>
      <main>
        <section className="hero">
          <div className="hero-copy"><div className="eyebrow"><span className="pulse-dot" /> A softer place to land</div><h1>Make room for<br /><em>better days.</em></h1><p>ZenHeaven brings your mental wellness toolkit into one quiet, caring space — whenever you need it.</p><div className="hero-actions"><Link to="/register" className="button button-primary button-lg">Start your journey <ArrowRight size={18} /></Link><a className="text-link" href="#how-it-works">Explore the space <ChevronRight size={16} /></a></div><div className="hero-note"><div className="avatar-stack"><span>J</span><span>M</span><span>A</span></div><span>Join a community choosing gentler growth</span></div></div>
          <div className="hero-art"><div className="sun-glow" /><div className="hero-orb orb-one" /><div className="hero-orb orb-two" /><div className="hero-card quote-card"><Sparkles size={18} /><p>“You don’t have to have it all figured out today.”</p><span>— your future self</span></div><div className="hero-card mood-card"><span className="mood-icon"><Sun size={22} /></span><div><small>Today’s check-in</small><strong>A little hopeful</strong></div><ChevronRight size={18} /></div><div className="art-label">breathe in <span>•</span> breathe out</div></div>
        </section>
        <section className="trusted"><span>Thoughtfully designed for your whole self</span><div><span><Heart size={15} /> self-aware</span><span><LockKeyhole size={15} /> private by default</span><span><Brain size={15} /> evidence-inspired</span></div></section>
