    ...
    <div className="landing">
      ...
      <section className="hero page-width">
        <div className="hero-copy">
          ...
          <h1>Make <br /><i>room for your whole self.</i></h1>
          <p className="hero-lede">A bright, playful toolkit for saying what you feel and finding a little momentum again.</p>
