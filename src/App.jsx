  ...
  return (
    <div className="app-shell">
      <aside className={`sidebar ${open ? "sidebar-open" : ""}`}>
        <div className="brand-mark"><span>05</span><div><b>zenheaven</b><small>{product.brand} / {product.descriptor}</small></div></div>
      ...
      <main className="main-content">
        <header className="mobile-header"><button onClick={() => setOpen(true)} aria-label="Open menu"><Menu /></button><div className="mobile-logo">Fairdrop</div><Link to="/coins"><Coins size={18} /></Link></header>
        <Outlet />
      </main>
    </div>
  );
  ...
  return (
    <div className="landing">
      <header className="landing-nav page-width">
        <Link to="/" className="brand-mark"><span>05</span><div><b>zenheaven</b><small>{product.brand} / {product.descriptor}</small></div></Link>
      ...
      <footer className="landing-footer page-width"><Link to="/" className="brand-mark"><span>05</span><div><b>zenheaven</b><small>{product.brand} / {product.descriptor}</small></div></Link><span>Built for the in-between moments / Fairdrop.</span></footer>
    </div>
  );
}
