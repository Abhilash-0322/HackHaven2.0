    ...
    <div className="landing">
      ...
      <section className="hero page-width">
        <div className="hero-copy">
          ...
          <h1>Shape <br /><i>a softer day.</i></h1>
          <p className="hero-lede">A playful, dimensional place to hold your thoughts, try a new ritual, and make support feel tangible.</p>
