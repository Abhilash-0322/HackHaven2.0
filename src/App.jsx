    ...
    <div className="landing">
      ...
      <section className="hero page-width">
        <div className="hero-copy">
          ...
          <h1>Make <br /><i>room for good days.</i></h1>
          <p className="hero-lede">A warm, welcoming corner for small rituals, honest feelings, and the comfort of being cared for.</p>
