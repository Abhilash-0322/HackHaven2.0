    ...
    <div className="landing">
      ...
      <section className="hero page-width">
        <div className="hero-copy">
          ...
          <h1>Breathe <br /><i>between the lines.</i></h1>
          <p className="hero-lede">A quiet practice for finding clarity in the imperfect, unfinished, and beautifully ordinary.</p>
