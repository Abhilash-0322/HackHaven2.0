    ...
    <div className="landing">
      ...
      <section className="hero page-width">
        <div className="hero-copy">
          ...
          <h1>A <br /><i>clear place to begin.</i></h1>
          <p className="hero-lede">A precise, spacious system for checking in, making meaning, and moving forward at your own pace.</p>
